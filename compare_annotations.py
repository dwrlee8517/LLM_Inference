...
def main(manual_filename, llm_filename):
    ...
    with open(os.path.join(manual_annotation_dir, llm_filename), "r") as f:
...
if __name__=='__main__':
    ...
    if args.manual and args.llm:
        ...
        llm_files = list_yaml_files(manual_annotation_dir)
        manual_file = select_file_from_list(manual_files, "manual annotation 1")
        llm_file = select_file_from_list(llm_files, "manual annotation 2")
